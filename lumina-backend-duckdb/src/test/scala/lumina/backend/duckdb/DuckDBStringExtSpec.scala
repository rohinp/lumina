...
/**
 * Tests for M17 extended string functions in DuckDBBackend: Replace,
 * RegexpExtract, RegexpReplace, StartsWith, EndsWith, LPad, RPad,
 * Repeat, Reverse, InitCap.
 *
 * Mirrors LocalBackendStringExtSpec to verify both backends agree.
 */
class DuckDBStringExtSpec extends FunSuite:
