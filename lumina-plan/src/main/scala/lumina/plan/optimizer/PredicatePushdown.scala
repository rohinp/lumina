...
object PredicatePushdown extends Rule:
  ...
  private def referencedColumns(expr: Expression): Set[String] = expr match
    ...
    case Day(e)              => referencedColumns(e)
    case Hour(e)             => referencedColumns(e)
    case Minute(e)           => referencedColumns(e)
    case Second(e)           => referencedColumns(e)
    case DayOfWeek(e)        => referencedColumns(e)
    case DateAdd(d, n)       => referencedColumns(d) ++ referencedColumns(n)
    case DateDiff(e, s)      => referencedColumns(e) ++ referencedColumns(s)
    case ToDate(e)           => referencedColumns(e)
    case ToTimestamp(e)      => referencedColumns(e)
    case DateFormat(e, _)    => referencedColumns(e)
